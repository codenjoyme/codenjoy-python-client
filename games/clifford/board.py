...
class Board:
    ...
    def is_game_over(self):
        return self._board.find_first(elements.get('HERO_DIE'),
                                      elements.get('HERO_MASK_DIE')) is not None
    ...
    def find_clues(self):
        return self._board.find(
            elements.get('CLUE_KNIFE'),
            elements.get('CLUE_GLOVE'),
            elements.get('CLUE_RING'))
